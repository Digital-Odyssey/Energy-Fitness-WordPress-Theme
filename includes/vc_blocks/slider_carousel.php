...
vc_map( array(
    "name" => __("Slider Carousel", 'energytheme'),
    ...
    "params" => array(
       ...
       array(
            "type" => "dropdown",
            "heading" => __("Animation Type", 'energytheme'),
            "param_name" => "el_animation",
            "description" => __("Choose between a slide or fade effect.", 'energytheme'),
...
vc_map( array(
    ...
    "params" => array(
        ...
        array(
            "type" => "textfield",
            "heading" => __("Alt attribute", 'energytheme'),
            "param_name" => "el_title",
            "description" => __("Enter a descriptive alt attribute - this is used for SEO purposes.", 'energytheme'),
			"value" => ''
        ),
		...
		array(
            ...
            "param_name" => "el_image",
            "description" => __("Upload an image for your slide.", 'energytheme')
        ),
