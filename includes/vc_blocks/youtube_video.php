...
vc_map( array(
    ...
    "name"      => __("YouTube Video", 'energytheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Video ID", 'energytheme'),
            "param_name" => "el_video_id",
            "description" => __("Enter your Youtube video ID.", 'energytheme')
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("Video width", 'energytheme'),
            "param_name" => "el_width",
            "description" => __("Enter a custom width for your video.", 'energytheme'),
			"value"      => 300, //Add default value in $atts
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("Video height", 'energytheme'),
            "param_name" => "el_height",
            "description" => __("Enter a custom height for your video.", 'energytheme'),
			"value"      => 250, //Add default value in $atts
        ),
		
		array(
            "type" => "dropdown",
            "heading" => __("Make video responsive?", 'energytheme'),
            "param_name" => "el_responsive",
            "description" => __("Enable responsiveness for your video - this value overrides the Video width value.", 'energytheme'),
