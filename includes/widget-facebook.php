...
class fb_likebox_widget extends WP_Widget {
	function fb_likebox_widget() {
		...
		$widget_ops = array('classname' => 'Like-box','description' => esc_html__('Facebook Like Box','energytheme'));

		parent::__construct('Like-box',esc_html__('[Micro Themes] - Facebook Likebox','energytheme'),$widget_ops);
...
function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_html__('Facebook','energytheme'),
			//'fa_icon' => '',
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e('Title:', 'energytheme') ?></label>
		...
		<p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'minimize_header' )); ?>"><?php esc_html_e('Minimize header?', 'energytheme'); ?></label>  
        </p>  
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_faces' )); ?>"><?php esc_html_e('Display faces?', 'energytheme'); ?></label>  
        </p> 
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_cover' )); ?>"><?php esc_html_e('Display cover?', 'energytheme'); ?></label>  
        </p> 
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_stream' )); ?>"><?php esc_html_e('Display stream?', 'energytheme'); ?></label>  
        </p>  

    	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'height' )); ?>"><?php esc_html_e('Height:', 'energytheme') ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'page' )); ?>"><?php esc_html_e('Facebook Page URL:', 'energytheme') ?></label>
