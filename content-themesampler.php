...
<div id="pm_theme_color_selector">
    ...
    <p class="pm_theme_color_selector_title"><?php esc_attr_e('Style Sampler','energytheme'); ?></p>

    <div class="pm_theme_color_selector_container">
        <p><?php esc_attr_e('Layout Style','energytheme'); ?></p>
        <select name="pm_theme_color_selector_mode" id="pm_theme_color_selector_mode">
          <option value="pm-full-mode" selected><?php esc_attr_e('Fullscreen','energytheme'); ?></option>
          <option value="pm-boxed-mode"><?php esc_attr_e('Boxed Mode','energytheme'); ?></option>
        </select>
    </div>
    <div class="pm_theme_color_selector_container">
        <p><?php esc_attr_e('Patterns for Boxed Mode','energytheme'); ?></p>
    ...
    <div class="pm_theme_color_selector_container">
        <p><?php esc_attr_e('Backgrounds for Boxed Mode','energytheme'); ?></p>
